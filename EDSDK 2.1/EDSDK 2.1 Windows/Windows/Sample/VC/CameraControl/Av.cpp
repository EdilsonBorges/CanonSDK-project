...
CAv::CAv()
{
	...
	_propertyTable.insert( std::pair<EdsUInt32, const char *>(0x2B,"4"));
	_propertyTable.insert( std::pair<EdsUInt32, const char *>(0x2C,"4.5"));
	_propertyTable.insert( std::pair<EdsUInt32, const char *>(0x2D,"5.6"));
	...
	_propertyTable.insert( std::pair<EdsUInt32, const char *>(0xffffffff,"unkown"));
}
