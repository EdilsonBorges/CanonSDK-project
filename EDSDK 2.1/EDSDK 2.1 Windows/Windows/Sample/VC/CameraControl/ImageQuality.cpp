...
CImageQuality::CImageQuality()
{
	...
	_propertyTable.insert( std::pair<EdsUInt32, const char *>(0x02640f0f, "Small RAW"));
	...
	_propertyTable.insert( std::pair<EdsUInt32, const char *>(0x02640010, "Small RAW + Large Jpegg"));
	...
	_propertyTable.insert( std::pair<EdsUInt32, const char *>(0x02640013, "Small RAW + Large Fine Jpeg"));
	_propertyTable.insert( std::pair<EdsUInt32, const char *>(0x02640113, "Small RAW + Middle Fine Jpeg"));
	_propertyTable.insert( std::pair<EdsUInt32, const char *>(0x02640213, "Small RAW + Small Fine Jpeg"));
	_propertyTable.insert( std::pair<EdsUInt32, const char *>(0x02640012, "Small RAW + Large Normal Jpeg"));
	_propertyTable.insert( std::pair<EdsUInt32, const char *>(0x02640112, "Small RAW + Middle Normal Jpeg"));
	_propertyTable.insert( std::pair<EdsUInt32, const char *>(0x02640212, "Small RAW + Small Normal Jpeg"));
